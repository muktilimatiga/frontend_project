...
export const MapsPage = () => {
  ...
  return (
    <div className="relative h-[calc(100vh-100px)] w-full rounded-xl overflow-hidden border border-slate-200 dark:border-white/20 shadow-sm animate-in fade-in duration-500">
